...
// frames in generated-photo-frame.ts work. Matches the per-career frames'
// own canvas size (see output-size.ts) so both frames produce the same
// output dimensions.
//
...
const CANVAS = { width: OUTPUT_WIDTH, height: OUTPUT_HEIGHT };
